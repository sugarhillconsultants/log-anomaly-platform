...
def run_canary(app_name: str, resource_group: str, new_revision_suffix: str,
    ...
    print(f"Last known-good revision: {good_revision}")
...
if __name__ == "__main__":
    ...
    run_canary(
        args.app_name, args.resource_group, args.new_revision_suffix,
